...
if handles.par.dgorrhd==1
    ...
    if handles.par.read_entire_file==1
        ...
        for ii=1+4*(handles.drta_p.tets-1):4+4*(handles.drta_p.tets-1)
            ...
            data_sub(:,jj)=data_this_trial(floor((handles.drta_p.subtractCh(ii)-1)*handles.draq_p.ActualRate*handles.draq_p.sec_per_trigger)+1:...
                floor((handles.drta_p.subtractCh(ii)-1)*handles.draq_p.ActualRate*handles.draq_p.sec_per_trigger)...
                +floor(handles.draq_p.ActualRate*handles.draq_p.sec_per_trigger)-2000);
            jj=jj+1;
        end
